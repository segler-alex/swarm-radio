...
function findCodecs(req, res, format, filter) {
    filter = filter || '';
    models.Station.findCodecs(filter).then((items) => {
        if (format === 'xml') {
            var converted = {
...
router.get('/webservice/:format/codecs', function(req, res) {
    var filter = '';
    var format = req.params.format;

    findCodecs(req, res, format, filter);
});

router.post('/webservice/:format/codecs', function(req, res) {
...
router.get('/webservice/:format/codecs/:filter', function(req, res) {
